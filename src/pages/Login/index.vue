            ...
            <form>
              ...
              <div class="setting clearFix">
                <label class="checkbox inline">
                  <input type="checkbox" @click="isAutoLogin=!isAutoLogin" />
                  自动登录
                </label>
...
export default {
  ...
  methods: {
    async userLogin() {
      try {
        const {phone, password, isAutoLogin} = this
        phone && password && await this.$store.dispatch('user/userLogin',{phone,password,isAutoLogin})
