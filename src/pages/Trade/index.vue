  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix">
        <span class="username" :class="{ selected: !pay }" @click="pay = !pay"
          >在线支付</span
        >
        <span
          class="username"
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        ...
        收货人：<span>{{ finalAddress.consignee }}</span> 电话：<span>{{
          finalAddress.phoneNum
        }}</span>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      const res = await this.$API.SubmitOrderAPI(this.tradeNo, data);
      if(res.code === 200){
  ...
  mounted() {
    this.$store.dispatch("user/userTradeInfo");
  },
};
</script>
